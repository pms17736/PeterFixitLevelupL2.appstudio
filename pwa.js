...
const cacheName = 'PeterFixitLevelupL2-2020-09-20 20:37:28.877380'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'PeterFixitLevelupL2'.length) === 'PeterFixitLevelupL2') {
